...
let init = (app) => {
    ...
    app.data = {
        ...
        show_new_post: false, //show new post text box
        show_reply: null, //shows reply text box for a post with _idx
        author_name, // is equal to author_name: author_name
        user_email, // is equal to user_email: author_name
    };
